...
رابط‌های برنامه‌نویسی سرویس‌های پشتیبان مختلف هنوز مفید هستند، زیرا انتقال به سرویس‌های پشتیبان جدید را نسبتاً بدون دردسر ممکن می‌سازند. اما همه راه‌اندازی‌های برنامه (محیط‌های توسعه، آزمون و عملیات) باید از یک نوع و یک نسخه‌ی یکسان از هر یک از خدمات پشتیبان استفاده کنند.