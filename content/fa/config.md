...
گاهی اوقات برنامه‌ها پیکربندی را به صورت ثابت در کد ذخیره می‌کنند. این مورد ناقص اصول دوازده-سازه است که مستلزم **جداسازی دقیق پیکربندی از کد** است. پیکربندی‌ها به طور قابل توجهی در بین استقرارها متفاوت هستند در حالی که در مخزن کد، این‌گونه نیست.
یک آزمون تورنسل برای اینکه آیا یک برنامه تمام پیکربندی‌ها را به درستی از کد خارج کرده است یا خیر، این است که آیا مخزن کد می تواند در هر لحظه به صورت یک کد منبع باز منتشر شود، بدون اینکه هیچ محرمانگی از برنامه به خطر بیفتد؟
